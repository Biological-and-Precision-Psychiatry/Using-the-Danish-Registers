...
This repo is relevant for users of the DST research server access under Michael E. Benros. The servers hold our access to and copy of the Danish registers. Our primary DST project is `708237`. 

The repo contains user guides and documents relevant for work on the registers and for exporting results from the DST servers for use in publications.
