...
You make a _server export request_ by sending an email to the data management team. The process and requirements of exporting from the DST servers is visualized in the following flowchart and described in the sections below.
